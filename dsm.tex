	...
	\begin{columns}[T]
		\begin{column}{.66\textwidth}
			\begin{itemize}
				...
				\item where $D \subset \mathbb{Z}^3 $ is rectangular subset of the discrete lattice:
				\item $D = \{(i,j,k)\hspace{1ex}\rvert\hspace{1ex}0 \leq i \leq I,\hspace{1ex} 0 \leq j \leq J,\hspace{1ex} 0 \leq k \leq K\} $
